...
<div id="content" class="speakers">
  <h1 class="topic_class"> Topic - Business and Management</h1>
  <br>
  <!-- Speaker 1_1 -->
  
  <div id="speaker1_1" class="speaker">
    
    <div id="img-div" class="align-self-center">
      <img id="image" src="images/speakers/adi_godrej.jpg" alt = "pic from flickr">
    </div>
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br><br>
        <h1 id="headline" >Adi Godrej</h1><br><br>
  ...
  <!-- Speaker 2_1 -->
  <h1 class="topic_class">Topic - Banking sector in India :<br> Present and Future </h1><br><br>
  <div id="speaker2_1" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br>
        <h1 id="headline" >Jaspal Singh Bindra</h1>
  ...
  <div id="speaker2_2" class="speaker">
  ...
  <div id="speaker2_3" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
        <h1 id="headline" >Chandra shekar Ghosh</h1>
...
-->
  ...
  <div id="speaker3_1" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
        <h1 id="headline" >Hitesh Oberoi</h1>
  ...
  <!-- Speaker 4_1 -->
  <h1 class="topic_class">Topic - Combined experience <br> sharing in various fields</h1><br>

  <div id="speaker4_1" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br>
        <h1 id="headline" >Narayan Murthy</h1>
        <br><br>
        <p>
  ...
  <div id="speaker4_2" class="speaker">
  ...
  <!-- Speaker 5_1 -->
  <h1 class="topic_class">Topic - Inclusive growth and <br> economic development</h1><br>

  <div id="speaker5_1" class="speaker">
    
    <div id="img-div" class="align-self-center">
      <img id="image" src="images/speakers/montek_singh_ahluwalia.png" alt = "pic from flickr">
    </div>
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br>
      <h1 id="headline" >Montek Singh Ahluwalia</h1><br>
  ...
  <!-- Speaker 6_1 -->
  <h1 class="topic_class">Topic - Corporate social responsibility</h1><br>

  <div id="speaker6_1" class="speaker">
  ...
  <div id="speaker6_2" class="speaker">
  ...
  <div id="speaker6_3" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br>
        <h1 id="headline" >Vithal V Kamath</h1><br>
  ...
  <div id="speaker6_4" class="speaker">
   ...
   <div id="speaker6_5" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br><br>
        <h1 id="headline" >Rajeev Dubey</h1><br>
  ...
  <div id="speaker6_6" class="speaker">
  ...
  <h1 class="topic_class">Topic - Past, Present and <br> Future of Ad-Tech</h1><br>


  <div id="speaker7_1" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
        <h1 id="headline" >Ashish Bhasin</h1>
  ...
  <h1 class="topic_class">Topic - Post-election Future of Indian Financial Markets</h1><br>

  <div id="speaker8_1" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
        <h1 id="headline" >Ramesh Damani</h1><br>
  ...
  <div id="speaker8_2" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
        <h1 id="headline" >M.K Sinha</h1><br>
  ...
  <div id="speaker8_3" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
        <h1 id="headline" >Raamdeo Aggarwal</h1>
  ...
  <div id="speaker8_4" class="speaker">
    ...
    <div id="speaker-info">
      ...
      <ul>
      <br>
        <h1 id="headline" >Utpal Sheth</h1><br>

<span class="topnav" id="myTopnav" style = "right: -3px">

	<div class="nav_tabs">
	    <a href="index_main.php" style = "color: #916b2f">Home</a>
	    <a href="aboutus.php" style = "color: #916b2f">About</a>
	  ...
	  <button class="button button4 before" style="float: left;" data-toggle = "modal" data-target = "#myModal" data-backdrop = "true">Attend</button>
